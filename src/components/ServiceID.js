            ...
            <React.Fragment>
                ...
                <section className="section">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <textarea placeholder="Saisissez les numéros service ID au format '75762XXXX'" onClick={this.test} name="idlist" value={this.state.textAreaValue} onChange={this.handleChange} rows="15" cols="33"/>
